      ...
      <header className="sticky top-0 z-50 bg-[#EEE9DF]/90 backdrop-blur-md border-b border-[#1B2632]/10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="font-serif text-2xl font-bold tracking-tight text-[#1B2632]">FinLingo</span>
            <span className="text-[10px] uppercase font-bold tracking-widest bg-[#A35139]/10 text-[#A35139] px-2.5 py-0.5 rounded-full">
              v1.0 Live
            </span>
          </div>
